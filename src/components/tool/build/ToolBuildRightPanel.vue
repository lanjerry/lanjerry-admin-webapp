...
<script>
  ...
  import TreeNodeDialog from '@/components/tool/build/ToolBuildTreeNodeDialog'
  import IconsDialog from '@/components/tool/build/ToolBuildIconsDialog'
  ...
  export default {
    name: 'ToolBuildRightPanel',
    components: { draggable, TreeNodeDialog, IconsDialog },
    ...
    computed: {
      documentLink() {
        return (
          this.activeData.document || 'https://element.eleme.cn/#/zh-CN/component/installation'
        )
      },
      dateOptions() {
