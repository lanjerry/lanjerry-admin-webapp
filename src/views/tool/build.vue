...
<script>
  ...
  import RightPanel from '@/components/tool/build/ToolBuildRightPanel'
  import CodeTypeDialog from '@/components/tool/build/ToolBuildCodeTypeDialog'
  import DraggableItem from '@/components/tool/build/ToolBuildDraggableItem'
  ...
  export default {
    name: 'ToolBuild',
    components: { draggable, render, RightPanel, CodeTypeDialog, DraggableItem },
    data() {
      return {
        logo,
        idGlobal: 100,
